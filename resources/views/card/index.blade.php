    ...
    <div class="card p-3">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                <h3>Cards</h3>
                <a href="{{route('cards.create')}}"><button class="btn btn-lg btn-primary">Create</button></a>
            </div>
        </div>
        <div class="card-body">
            <div class="row">
                    ...
                    <table class="table table-bordered table-responsive-md">
                        ...
                        @foreach($cards as $k=>$card )
                            <tr>
                                ...
                                <td><img src="{{asset('storage/centerImages/'.$card->back_image)}}" alt="" height="75px" width="75px"></td>
                                <td><img src="{{asset('storage/backgroundsImages/'.$card->center_image)}}" alt="" height="75px" width="75px"></td>
